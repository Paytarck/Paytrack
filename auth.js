...
export async function updateGlobalCard(project, projectData) {
    ...
    const payload = {
        ...
        lastUpdated: projectData.lastUpdated, // CRITICAL
   ...
   try {
        ...
        // If the file is still too big, show an alert instead of failing silently
        if (e.message.includes('too large')) {
            alert("Error: This photo is too large even after shrinking. Please try a different photo.");
        }
    }
}
