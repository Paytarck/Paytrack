const translations = {
  en: {
    ...
    shortcutTransactionsTitle: "Shortcut Transactions",
    shortcutTransactionsSubtitle: "Quickly add frequent transactions.",
    noShortcutsYet: "No Shortcuts Yet",
    noShortcutsDescription: "Create a shortcut from the transaction modal to add it here.",
    autoTransactions: "Auto Transactions",
    scheduleAutomation: "Schedule Automation",
    scheduleAutomationDescription: "This transaction will be automatically added based on your schedule when you open the app.",
    frequency: "Frequency",
    daily: "Daily",
    weekly: "Weekly",
    monthly: "Monthly",
    ...
    time: "Time",
    autoTransactionsTitle: "Auto Transactions",
    autoTransactionsSubtitle: "Manage your scheduled transactions.",
  ...
  es: {
    ...
    makeShortcut: "Crear Atajo",
    shortcutTransactionsTitle: "Transacciones de Acceso Rápido",
    shortcutTransactionsSubtitle: "Añade rápidamente transacciones frecuentes.",
    noShortcutsYet: "Aún No Hay Atajos",
    noShortcutsDescription: "Crea un atajo desde el modal de transacciones para añadirlo aquí.",
    autoTransactions: "Transacciones Automáticas",
    scheduleAutomation: "Programar Automatización",
    scheduleAutomationDescription: "Esta transacción se agregará automáticamente según su horario cuando abra la aplicación.",
    ...
    time: "Hora",
    autoTransactionsTitle: "Transacciones Automáticas",
    autoTransactionsSubtitle: "Gestiona tus transacciones programadas.",
  ...
  ur: {
    ...
    makeShortcut: "شارٹ کٹ بنائیں",
    shortcutTransactionsTitle: "شارٹ کٹ ٹرانزیکشنز",
    shortcutTransactionsSubtitle: "بار بار ہونے والی ٹرانزیکشنز کو تیزی سے شامل کریں۔",
    noShortcutsYet: "ابھی تک کوئی شارٹ کٹ نہیں ہے۔",
    noShortcutsDescription: "یہاں شامل کرنے کے لیے ٹرانزیکشن موڈل سے ایک شارٹ کٹ بنائیں۔",
    autoTransactions: "خودکار ٹرانزیکشنز",
    scheduleAutomation: "آٹومیشن کا شیڈول بنائیں",
    scheduleAutomationDescription: "جب آپ ایپ کھولیں گے تو یہ لین دین آپ کے شیڈول کے مطابق خود بخود شامل ہو جائے گی۔",
    frequency: "تعدد",
    daily: "روزانہ",
    weekly: "ہفتہ وار",
    monthly: "ماہانہ",
    ...
    time: "وقت",
    autoTransactionsTitle: "خودکار ٹرانزیکشنز",
    autoTransactionsSubtitle: "اپنی طے شدہ ٹرانزیکشنز کا نظم کریں۔",
...
// Ensure functions are globally accessible via the window object
