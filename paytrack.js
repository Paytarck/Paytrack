...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (remoteTS > localTS) {
        console.log("📥 Receiving project update (Name/Date/Metadata)...");
        ...
        // 4. Force calculation refresh (Total/Paid/Pending cards)
        recalculateTotals();
        updateSummary();
        
        // 5. Apply theme in case it was changed
        applyTheme(currentSettings.theme);
        
        // This ensures the "Agreement Modal" shows the new data immediately
