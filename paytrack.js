...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (remoteTS > localTS) {
        console.log("🔄 Deep Sync: Metadata & Totals updated from cloud.");
        
        // 1. Save all parts to LocalStorage
        ...
        // 3. CRITICAL: Refresh the UI for the new Total Amount and Name
        ...
        if (elements.totalCost) {
            ...
            updateTotalCostWords(); // Refresh the words under the input
        }

        // 4. Recalculate and update the summary cards/progress bar
        recalculateTotals();
        updateSummary();
        
        // 5. Check if we need to switch from "Setup Form" to "Payment Form"
        updateUIMode(); 
        
        // 6. If the Agreement Modal was open, it will now show new info next time it's clicked
