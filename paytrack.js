...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (remoteTS > localTS) {
        console.log("🔄 Syncing from other device...");

        // 1. Overwrite Local Storage
        ...
        // 3. FORCE UI REFRESH (This is why it wasn't working)
        ...
        // Refresh Summary Cards and Progress Bar
        recalculateTotals();
        updateSummary();
        
        // 4. Update the Agreement Modal if it's currently open
